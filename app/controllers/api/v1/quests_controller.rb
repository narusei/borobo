class Api::V1::QuestsController < ApplicationController
    ...
    def create
        ...
        @quest = Quest.create!( title:params[:title], stance:params[:stance], category:params[:category],tags:params[:tags],detail:params[:detail],start_date:params[:start_date],due_date:params[:due_date],reward:params[:reward],user_id:current_api_user)
